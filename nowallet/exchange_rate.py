...
async def fetch_from_api(base_url: str,
    ...
    return json.loads(await urlopen(url))  # type: Dict[str, Dict]

async def fetch_exchange_rates(chain_1209k: str = "btc") -> Dict[str, Dict]:
    ...
    btcav_json = await fetch_from_api(btcav_url, chain_1209k)  # type: Dict[Any]
    ...
    ccomp_json = await fetch_from_api(ccomp_url, chain_1209k)  # type: Dict[Any]
